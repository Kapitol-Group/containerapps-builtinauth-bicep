...
T = TypeVar("T", bound="TitleBlockValidationUsers")


@_attrs_define
class TitleBlockValidationUsers:
    """
    Attributes:
        user_email (str):
        id (UUID | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title_block_validation_users = cls(
        ...
        title_block_validation_users.additional_properties = d
        return title_block_validation_users
