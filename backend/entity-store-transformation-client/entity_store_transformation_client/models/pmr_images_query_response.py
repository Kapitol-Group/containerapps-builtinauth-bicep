...
T = TypeVar("T", bound="PMRImagesQueryResponse")


@_attrs_define
class PMRImagesQueryResponse:
    """
    Attributes:
        ...
        value (list[PMRImages] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[PMRImages] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = PMRImages.from_dict(value_item_data)

                value.append(value_item)

        pmr_images_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        pmr_images_query_response.additional_properties = d
        return pmr_images_query_response
