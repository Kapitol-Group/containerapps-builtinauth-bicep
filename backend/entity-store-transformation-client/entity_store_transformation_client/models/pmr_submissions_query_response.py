...
if TYPE_CHECKING:
    from ..models.pmr_submissions import PMRSubmissions


T = TypeVar("T", bound="PMRSubmissionsQueryResponse")


@_attrs_define
class PMRSubmissionsQueryResponse:
    """
    Attributes:
        ...
        value (list[PMRSubmissions] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[PMRSubmissions] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = PMRSubmissions.from_dict(value_item_data)

                value.append(value_item)

        pmr_submissions_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        pmr_submissions_query_response.additional_properties = d
        return pmr_submissions_query_response
