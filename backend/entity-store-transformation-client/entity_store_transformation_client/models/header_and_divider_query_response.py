...
if TYPE_CHECKING:
    from ..models.header_and_divider import HeaderAndDivider


T = TypeVar("T", bound="HeaderAndDividerQueryResponse")


@_attrs_define
class HeaderAndDividerQueryResponse:
    """
    Attributes:
        ...
        value (list[HeaderAndDivider] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[HeaderAndDivider] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = HeaderAndDivider.from_dict(value_item_data)

                value.append(value_item)

        header_and_divider_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        header_and_divider_query_response.additional_properties = d
        return header_and_divider_query_response
