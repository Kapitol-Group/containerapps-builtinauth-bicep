...
if TYPE_CHECKING:
    from ..models.trade_partner_risks_issues import TradePartnerRisksIssues


T = TypeVar("T", bound="TradePartnerRisksIssuesQueryResponse")


@_attrs_define
class TradePartnerRisksIssuesQueryResponse:
    """
    Attributes:
        ...
        value (list[TradePartnerRisksIssues] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[TradePartnerRisksIssues] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = TradePartnerRisksIssues.from_dict(value_item_data)

                value.append(value_item)

        trade_partner_risks_issues_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        trade_partner_risks_issues_query_response.additional_properties = d
        return trade_partner_risks_issues_query_response
