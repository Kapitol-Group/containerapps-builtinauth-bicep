...
T = TypeVar("T", bound="DrawingDisciplinesQueryResponse")


@_attrs_define
class DrawingDisciplinesQueryResponse:
    """
    Attributes:
        ...
        value (list[DrawingDisciplines] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[DrawingDisciplines] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = DrawingDisciplines.from_dict(value_item_data)

                value.append(value_item)

        drawing_disciplines_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        drawing_disciplines_query_response.additional_properties = d
        return drawing_disciplines_query_response
