...
if TYPE_CHECKING:
    from ..models.pmr_building_permit_status import PMRBuildingPermitStatus


T = TypeVar("T", bound="PMRBuildingPermitStatusQueryResponse")


@_attrs_define
class PMRBuildingPermitStatusQueryResponse:
    """
    Attributes:
        ...
        value (list[PMRBuildingPermitStatus] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[PMRBuildingPermitStatus] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = PMRBuildingPermitStatus.from_dict(value_item_data)

                value.append(value_item)

        pmr_building_permit_status_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        pmr_building_permit_status_query_response.additional_properties = d
        return pmr_building_permit_status_query_response
