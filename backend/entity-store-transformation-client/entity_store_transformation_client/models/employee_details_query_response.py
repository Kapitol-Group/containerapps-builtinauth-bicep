...
T = TypeVar("T", bound="EmployeeDetailsQueryResponse")


@_attrs_define
class EmployeeDetailsQueryResponse:
    """
    Attributes:
        ...
        value (list[EmployeeDetails] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[EmployeeDetails] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = EmployeeDetails.from_dict(value_item_data)

                value.append(value_item)

        employee_details_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        employee_details_query_response.additional_properties = d
        return employee_details_query_response
