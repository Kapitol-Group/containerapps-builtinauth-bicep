...
if TYPE_CHECKING:
    from ..models.employee_int_experience import EmployeeIntExperience


T = TypeVar("T", bound="EmployeeIntExperienceQueryResponse")


@_attrs_define
class EmployeeIntExperienceQueryResponse:
    """
    Attributes:
        ...
        value (list[EmployeeIntExperience] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[EmployeeIntExperience] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = EmployeeIntExperience.from_dict(value_item_data)

                value.append(value_item)

        employee_int_experience_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        employee_int_experience_query_response.additional_properties = d
        return employee_int_experience_query_response
