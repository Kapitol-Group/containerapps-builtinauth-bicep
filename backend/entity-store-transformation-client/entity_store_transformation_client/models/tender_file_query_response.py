...
T = TypeVar("T", bound="TenderFileQueryResponse")


@_attrs_define
class TenderFileQueryResponse:
    """
    Attributes:
        ...
        value (list[TenderFile] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[TenderFile] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = TenderFile.from_dict(value_item_data)

                value.append(value_item)

        tender_file_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        tender_file_query_response.additional_properties = d
        return tender_file_query_response
