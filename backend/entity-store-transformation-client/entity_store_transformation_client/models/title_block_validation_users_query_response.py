...
T = TypeVar("T", bound="TitleBlockValidationUsersQueryResponse")


@_attrs_define
class TitleBlockValidationUsersQueryResponse:
    """
    Attributes:
        ...
        value (list[TitleBlockValidationUsers] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[TitleBlockValidationUsers] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = TitleBlockValidationUsers.from_dict(value_item_data)

                value.append(value_item)

        title_block_validation_users_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        title_block_validation_users_query_response.additional_properties = d
        return title_block_validation_users_query_response
