...
T = TypeVar("T", bound="SystemUserQueryResponse")


@_attrs_define
class SystemUserQueryResponse:
    """
    Attributes:
        ...
        value (list[SystemUser] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[SystemUser] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = SystemUser.from_dict(value_item_data)

                value.append(value_item)

        system_user_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        system_user_query_response.additional_properties = d
        return system_user_query_response
