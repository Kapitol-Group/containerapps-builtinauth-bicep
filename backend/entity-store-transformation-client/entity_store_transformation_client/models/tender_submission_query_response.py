...
T = TypeVar("T", bound="TenderSubmissionQueryResponse")


@_attrs_define
class TenderSubmissionQueryResponse:
    """
    Attributes:
        ...
        value (list[TenderSubmission] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[TenderSubmission] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = TenderSubmission.from_dict(value_item_data)

                value.append(value_item)

        tender_submission_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        tender_submission_query_response.additional_properties = d
        return tender_submission_query_response
