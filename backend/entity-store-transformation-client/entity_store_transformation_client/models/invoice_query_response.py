...
T = TypeVar("T", bound="InvoiceQueryResponse")
...
class InvoiceQueryResponse:
    ...
    Attributes:
        ...
        value (list[Invoice] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[Invoice] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = Invoice.from_dict(value_item_data)

                value.append(value_item)

        invoice_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        invoice_query_response.additional_properties = d
        return invoice_query_response
