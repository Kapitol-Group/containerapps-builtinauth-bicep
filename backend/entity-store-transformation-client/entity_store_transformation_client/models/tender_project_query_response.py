...
T = TypeVar("T", bound="TenderProjectQueryResponse")


@_attrs_define
class TenderProjectQueryResponse:
    """
    Attributes:
        ...
        value (list[TenderProject] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[TenderProject] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = TenderProject.from_dict(value_item_data)

                value.append(value_item)

        tender_project_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        tender_project_query_response.additional_properties = d
        return tender_project_query_response
