...
T = TypeVar("T", bound="PMRActionsQueryResponse")


@_attrs_define
class PMRActionsQueryResponse:
    """
    Attributes:
        ...
        value (list[PMRActions] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[PMRActions] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = PMRActions.from_dict(value_item_data)

                value.append(value_item)

        pmr_actions_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        pmr_actions_query_response.additional_properties = d
        return pmr_actions_query_response
