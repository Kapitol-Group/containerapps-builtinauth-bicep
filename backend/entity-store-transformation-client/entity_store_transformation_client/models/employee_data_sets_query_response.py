...
if TYPE_CHECKING:
    from ..models.employee_data_sets import EmployeeDataSets


T = TypeVar("T", bound="EmployeeDataSetsQueryResponse")


@_attrs_define
class EmployeeDataSetsQueryResponse:
    """
    Attributes:
        ...
        value (list[EmployeeDataSets] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[EmployeeDataSets] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = EmployeeDataSets.from_dict(value_item_data)

                value.append(value_item)

        employee_data_sets_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        employee_data_sets_query_response.additional_properties = d
        return employee_data_sets_query_response
