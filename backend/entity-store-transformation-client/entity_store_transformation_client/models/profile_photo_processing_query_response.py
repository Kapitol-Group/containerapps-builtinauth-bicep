...
if TYPE_CHECKING:
    from ..models.profile_photo_processing import ProfilePhotoProcessing


T = TypeVar("T", bound="ProfilePhotoProcessingQueryResponse")


@_attrs_define
class ProfilePhotoProcessingQueryResponse:
    """
    Attributes:
        ...
        value (list[ProfilePhotoProcessing] | Unset):
    """

    total_record_count: int | Unset = UNSET
    value: list[ProfilePhotoProcessing] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = ProfilePhotoProcessing.from_dict(value_item_data)

                value.append(value_item)

        profile_photo_processing_query_response = cls(
            total_record_count=total_record_count,
            value=value,
        )

        profile_photo_processing_query_response.additional_properties = d
        return profile_photo_processing_query_response
