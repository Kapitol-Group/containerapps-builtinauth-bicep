...
T = TypeVar("T", bound="ProfilePhotoProcessing")


@_attrs_define
class ProfilePhotoProcessing:
    """
    Attributes:
        file_path (str):
        id (UUID | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        profile_photo_processing.additional_properties = d
        return profile_photo_processing
