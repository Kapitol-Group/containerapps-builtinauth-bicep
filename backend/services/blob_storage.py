    ...
    def list_files(self, tender_id: str, exclude_batched: bool = False) -> List[Dict]:
        ...
        for blob in blob_list:
            ...
            files.append({
                ...
                'revision_date': blob.metadata.get('revision_date') if blob.metadata else None,
    ...
    def get_file_info(self, tender_id: str, file_path: str) -> Optional[Dict]:
        ...
        try:
            ...
            return {
                ...
                'revision_date': properties.metadata.get('revision_date') if properties.metadata else None,
